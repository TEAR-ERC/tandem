...
# mpiexec -bind-to core -n 40 tandem $setup_dir/parameters_tmp.toml --petsc -ts_checkpoint_freq_step 10000000000 -ts_checkpoint_freq_cputime 100000000000000 -ts_checkpoint_freq_physical_time 10000000000000000 -options_file $tdhome/options/lu_mumps.cfg -options_file $tdhome/options/rk45.cfg -ts_monitor > $setup_dir/messages_$branch_n.log &
