...
Tandem may be used in 2D and 3D and supports low-order as well as high-order spaces.
The specific configuration is selected at compile time, which is why tandem needs
to compiled from source.
