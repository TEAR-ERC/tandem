...
function BP3:mu(x, y, tag)
    -- In a real application, you would use the tag to determine the material properties.
    -- for example:
    -- if tag == 1 then
    --     return 1.0
    -- elseif tag == 2 then
...
function BP3:lam(x, y, tag)
    -- Similar to mu, you would use the tag to determine the material properties for lambda.
