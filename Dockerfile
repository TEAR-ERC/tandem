...
RUN apt-get update \
    && apt-get install -y --no-install-recommends ca-certificates gcc g++ gfortran libgomp1 make cmake cmake-curses-gui libopenmpi-dev libopenmpi3 git libeigen3-dev python3 python3-numpy liblua5.3-0 liblua5.3-dev vim zlib1g zlib1g-dev \
    && rm -rf /var/lib/apt/lists/*
