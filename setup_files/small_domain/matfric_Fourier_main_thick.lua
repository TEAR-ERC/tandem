...
function BP1:ab(x, y)
    ...
    local _ab3 = self.a_b2 + (self.a_b3 - self.a_b2) * (z - self.H) / (self.Wf - self.H)
...
function BP1:a(x, y)
    ...
    local _a = _ab + self.b
    file = io.open ('/home/jyun/Tandem/small_domain/ab_profile_thick','a')
    io.output(file)
