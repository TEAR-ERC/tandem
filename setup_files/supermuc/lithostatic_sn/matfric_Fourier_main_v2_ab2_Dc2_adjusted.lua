...
y_sn,fractal_sn = read_fractal('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/lithostatic_sn/fractal_litho_snpre_02')
y_tau,fractal_tau = read_fractal('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/lithostatic_sn/fractal_litho_finaltau_02')
...
function BP1:L(x, y)
    ...
    file = io.open ('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/lithostatic_sn/dc_profile_v2_ab2_Dc2_adjusted','a')
    io.output(file)
    io.write(y,'\t',het_L,'\n')
    io.close(file)
    return het_L
...
function BP1:a(x, y)
    ...
    local _a = _ab + self.b
    file = io.open ('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/lithostatic_sn/ab_profile_v2_ab2_Dc2_adjusted','a')
    io.output(file)
