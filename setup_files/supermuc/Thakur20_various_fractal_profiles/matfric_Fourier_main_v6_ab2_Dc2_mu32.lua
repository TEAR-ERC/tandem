...
function BP1:L(x, y)
    ...
    file = io.open ('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/Thakur20_various_fractal_profiles/dc_profile_v6_ab2_Dc2_mu32','a')
    io.output(file)
    io.write(y,'\t',het_L,'\n')
    io.close(file)
    return het_L
...
function BP1:a(x, y)
    ...
    local _a = _ab + self.b
    file = io.open ('/hppfs/work/pn49ha/di75weg/jeena-tandem/setup_files/supermuc/Thakur20_various_fractal_profiles/ab_profile_v6_ab2_Dc2_mu32','a')
    io.output(file)
