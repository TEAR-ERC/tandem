...
function BP1:a(x, y)
    ...
    local _a = _ab + self.b
    file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/ab_profile_v6_ab2','a')
    io.output(file)
...
function BP1:tau_pre(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/stress_profile_v6_ab2','a')
    io.output(file)
    io.write(y,'\t',_sn,'\t',_tau,'\n')
    io.close(file)
    return _tau
