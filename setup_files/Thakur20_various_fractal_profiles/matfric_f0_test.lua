...
fractal_file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/fractal_f0_01','r')
lines = fractal_file:lines()
local fault_y = {}
local fc = {}
_y,_fc = fractal_file:read('*number', '*number')
if _y ~= nil then
...
function BP1:f0(x, y)
    local _f0 = linear_interpolation(fault_y, fc, y)
    if y > 0 then
        _f0 = 0.7
    end
    print(_f0)
