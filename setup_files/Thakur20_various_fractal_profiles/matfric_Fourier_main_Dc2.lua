...
fractal_file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/fractal_Dc_02','r')
...
function BP1:L(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/dc_profile_Dc2','a')
    io.output(file)
    io.write(y,'\t',het_var,'\n')
    io.close(file)
    -- print(x,y,het_var)
