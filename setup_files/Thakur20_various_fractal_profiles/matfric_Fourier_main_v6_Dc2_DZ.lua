...
y_dc,fractal_dc = read_fractal('/home/jyun/Tandem/Thakur20_various_fractal_profiles/fractal_Dc_02')
...
function BP1:L(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/dc_profile_v6_Dc2_DZ','a')
    io.output(file)
    io.write(y,'\t',het_L,'\n')
    io.close(file)
    return het_L
...
function BP1:tau_pre(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/Thakur20_various_fractal_profiles/stress_profile_v6_Dc2_DZ','a')
    io.output(file)
    io.write(y,'\t',_sn,'\t',_tau,'\n')
    io.close(file)
    return _tau
