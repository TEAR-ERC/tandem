...
sed "s/DEGREE/$POLYNOMIAL_DEGREE/g" bp1_ref_QDGreen.toml > bp1_ref_QDGreen_temp.toml
${EXECUTABLE_DIR}/app/tandem bp1_ref_QDGreen_temp.toml \
--petsc -options_file solver.cfg > ${TEMP_TEST_RESULTS}/seas_regression_QDGreen.log

# clean up the temp config file
rm bp1_ref_QDGreen_temp.toml
