...
int main(int argc, char** argv) {
    ...
    argparse::ArgumentParser program("gf-strumpack-full-bench");
    ...
    if (cfg->mode != SeasMode::QuasiDynamicDiscreteGreen) {
        std::cerr << "gf-strumpack-full-bench: mode must be QDGreen" << std::endl;
        return -1;
    }
    ...
    double rel_err = validateGFStrumpackFull(*mesh, *cfg);
