...
double warpAndBlendAlpha(std::size_t D, unsigned degree) {
    ...
    constexpr double alphaOpt3[] = {0.0,    0.0,      0.0,      0.1002,   1.1332,  1.5608, 1.3413,
                                    1.2577, 1.1603,   1.10153,  0.6080,   0.4523,  0.8856, 0.8717,
                                    0.9655, 0.982344, 0.827846, 0.700081, 0.725887};
...
std::vector<std::array<double, 1>> WarpAndBlendFactory<1>::operator()(unsigned degree) const {
    ...
    GeneralPlexToRefPlex equiToRef(gllVerts);
