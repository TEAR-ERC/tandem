...
template<>
std::array<GenMesh<1>::simplex_t,1> GenMesh<1>::tessellate(std::array<int,2> const& vertGIDs, bool) {
...
template<>
std::array<GenMesh<2>::simplex_t,2> GenMesh<2>::tessellate(std::array<int,4> const& vertGIDs, bool isOdd) {
...
template<>
std::array<GenMesh<3>::simplex_t,5> GenMesh<3>::tessellate(std::array<int,8> const& vertGIDs, bool isOdd) {
