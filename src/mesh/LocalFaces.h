...
public:
    ...
    void setVolumeTagData(std::unique_ptr<MeshData> data) { volumeTagData_ = std::move(data); }
    MeshData const* getVolumeTagData() const { return volumeTagData_.get(); }
...
private:
    ...
    std::unique_ptr<MeshData> volumeTagData_;
};
